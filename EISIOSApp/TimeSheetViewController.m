...
-(void)tableServiceCall
{
    ...
    NSString *projectLstForTask =[NSString stringWithFormat:@"timesheet/v1/timeSheetList?userId=%@&userType=%@&orgId=%@",Useridstr,Usertypestr,orgIdstr];
...
//                [self tableServiceCall];
    ...
    else if(alertView == alertView1)
    {
        ...
        Servicecall = [[Webservices alloc]init];
        NSString *projectLstForTask = [NSString stringWithFormat:@"timesheet/v1/approveTimeSheet"];
;
